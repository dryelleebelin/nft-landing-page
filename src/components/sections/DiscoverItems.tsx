...
export default function DiscoverItems() {
  return (
    <motion.section
      ...
      className="bg-slate-900 min-h-screen flex flex-col items-center justify-center px-8 md:px-30 pb-18 md:py-18 gap-6"
    >
      ...
      <motion.div className="w-full flex flex-col md:flex-row md:justify-evenly gap-8 md:gap-0 pt-4">
        {items.map((item) => (
