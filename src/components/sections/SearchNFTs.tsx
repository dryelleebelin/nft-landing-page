  ...
  return (
    <section className="bg-slate-900 h-auto md:h-[60vh] pt-16 flex justify-center items-start px-8 md:px-0 pb-16 md:pb-10">
      ...
      >
        ...
        <div className="w-full md:w-2/3 flex flex-col justify-center px-6 md:px-12 py-10 gap-2">
          <h3 className="text-2xl md:text-3xl font-bold text-white text-center md:text-left">
            Encontre sua inspiração
          </h3>

          <p className="text-slate-200 max-w-md text-center md:text-left">
            Busque NFTs dos seus colecionadores favoritos ao redor do mundo
          </p>

          <motion.div
            whileFocus={{ scale: 1.02 }}
            className="mt-2 flex w-full max-w-md mx-auto md:mx-0"
          >
            <input
              type="text"
