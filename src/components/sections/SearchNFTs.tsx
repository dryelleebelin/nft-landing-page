  ...
  return (
    <section className="bg-slate-900 h-auto md:h-[60vh] pt-16 flex justify-center items-start px-8 md:px-0 pb-20 md:pb-0">
      <motion.div
        ...
        className="relative bg-gradient-to-r from-sky-500 via-blue-800 to-slate-950 h-auto md:h-[70%] w-full md:w-2/3 rounded-2xl shadow-xl flex flex-col-reverse md:flex-row overflow-visible"
      ...
      >
        ...
        <div className="w-full md:w-2/3 flex flex-col justify-center text-white px-6 md:px-12 py-10 gap-3">
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="rounded-r-lg bg-blue-600/80 px-6 py-3 text-sm font-semibold text-white hover:bg-blue-600 transition cursor-pointer"
            >
              Pesquisar
            </motion.button>
          </motion.div>
