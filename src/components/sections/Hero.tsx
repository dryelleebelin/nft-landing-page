    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <Image
          src={blobSolid}
          alt="Blob solid"
          className="pointer-events-none absolute -top-42 right-40 hidden md:block w-64 opacity-50"
        />
      ...
      <div className="w-full md:w-3/5 px-6 md:pr-30 flex flex-col text-center md:text-end justify-center gap-4 z-10">
        <motion.h2 variants={fadeUp} className="text-2xl md:text-5xl text-blue-400 font-semibold">
          Crie Seus Próprios NFTs
        </motion.h2>

        <motion.h1 variants={fadeUp} className="text-3xl md:text-6xl font-bold text-white">
        ...
        <motion.div variants={fadeUp} className="flex flex-col md:flex-row justify-center md:justify-end gap-4 mt-6 items-center">
          <button
            type="button"
            className="w-auto bg-gradient-to-l from-blue-700 to-blue-500 rounded-full py-2 px-6 font-semibold flex items-center justify-center hover:brightness-110 transition-all duration-300 shadow-md cursor-pointer"
          >
            Começar Agora
          </button>
          ...
          <button
            type="button"
            className="w-auto relative inline-flex items-center justify-center rounded-full p-[2px] bg-gradient-to-l from-blue-700 to-blue-500 hover:brightness-110 transition-all duration-300 cursor-pointer"
          >
            <span className="rounded-full bg-slate-950 px-6 py-2 font-semibold">
              Saiba Mais
            </span>
          </button>
        </motion.div>
